...
from data import TextDataset, TransformDataset, pad_collate_fn
...
def main():
    ...
    trainloader = DataLoader(trainset, batch_size, True, collate_fn=pad_collate_fn, num_workers=num_workers)
    valloader = DataLoader(valset, batch_size, True, collate_fn=pad_collate_fn, num_workers=num_workers)
